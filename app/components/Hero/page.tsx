    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto text-center space-y-8 z-10">
        ...
        >
          ...
          <span className="bg-clip-text text-transparent bg-linear-to-r from-sky-400 via-blue-500 to-purple-500">
            Cinematic Stories
          </span>
        </motion.h1>
        ...
        >
          I'm a professional video editor specializing in YouTube content, commercial edits, high-converting social ads, and cinematic color grading.
        </motion.p>
